...
rasterizeFFImage <- function(arow, proj="+proj=utm +zone=11  +datum=WGS84", correct_meta = scene_with_FF_UTM){
...
getSpatialPolysForOneImage <- function(aframe, proj= "+proj=utm +zone=11 +ellps=WGS84 +datum=WGS84 +units=m +no_defs") {
...
#takes a dataframe and returns a SpatialPolygons object
getSpatialPolysDataFrameForOneImage <- function(aframe, proj= "+proj=utm +zone=11 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"){
