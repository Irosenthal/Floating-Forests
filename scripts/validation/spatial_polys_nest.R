...
classifications_clean <- classifications
...
sp_classifications_df <- data.frame(matrix(ncol = 1, nrow = 15))
...
sp_classifications_df$caKelp.spoints <- rep(list(caKelp.spoints), 15)
